...
const ESLINT_CLI_RELATIVE_PATH = "node_modules/eslint/bin/eslint.js";
...
async function checkAncestorEslint() {
    ...
    while (true) {
        const candidate = resolve(directory, ESLINT_CLI_RELATIVE_PATH);
...
async function getEslintCliPath() {
    ...
    const ancestor = await checkAncestorEslint();
