...
program
    ...
    .option("--selectorPath <selectorPath>", "Selector Path", "./src/Selectors/")
    .option("-e, --event", "Create Event", false)
    .option("--eventPath <eventPath>", "Event Path", "./src/app/Listeners/")
    .option("--handlerPath <handlerPath>", "Handler Path", "./src/Handlers/")
