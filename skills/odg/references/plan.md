...
1. Read the local AGENTS.md file if one exists — it defines the mandatory pre-action checklist and required package reads.
2. Read [@odg/command/AGENTS.md]($$PROJECT_ROOT/node_modules/@odg/command/AGENTS.md) before deciding flags or artifacts.
